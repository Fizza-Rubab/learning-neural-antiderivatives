...
def main():
    ...
    ckpt_root = "/HPS/n_ntumba/work/Fizza_project/Experiment1d_with_blur"
    eval_dir = "evaluation_1d_dog_blur"
    ...
    for order in orders:
        ...
        for fname in os.listdir(pose_dir):
            ...
            ckpt_path = os.path.join(ckpt_root, f"{base_name}_motion1d_order_2_gaussian_0.03_samples_100000.npy_1d_scale_0.01_order_1_gpu.pth")
