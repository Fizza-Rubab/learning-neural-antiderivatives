...
def main():
    ...
    ckpt_root = "/HPS/antiderivative_project/work/NFC-Blur/experiments/results_2d"
    ...
    for fname in os.listdir(image_dir):
        ...
        for order in [1]:
            ckpt_path = os.path.join(ckpt_root, f"NFC-Blur_{base_name}_2d_order_{order}_minimal_0.04_samples_200000_order={order}", "current.pth")
