...
def _parse_args():
    ...
    parser.add_argument("--analytic", type=str, default="none", help="seed value for the training")
...
def _main():
    ...
    if args.blur == 1:
        ...
        if args.analytic.lower() in ["gm", "ackley", "hr"]:
            ...
            monte_carlo_gt = mesh_to_sdf_tensor(args.monte_carlo, 256)
    ...
    print(f'training randomly : ---------------------', flush=True)
    train(SAVE_PATH,
          args,
          model,
          optim,
