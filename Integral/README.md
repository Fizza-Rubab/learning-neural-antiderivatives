...
Used to evaluate a particular model trained with Integral for a convolution task. 

```bash
python eval.py --model_path="../models/Integral/1d/subject_0_order=2.pth" 
python eval.py --model_path="../models/Integral/2d/0085_order=1.pth" 
python eval.py --model_path="../models/Integral/3d/FAUST_tr_reg_077_order=1.pth" 
```
