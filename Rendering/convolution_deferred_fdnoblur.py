...
class SceneOP(OpenGLOP):
    def __init__(self, resolution):
        ...
        self.shininess = 64
        self.order = 1
        os.makedirs(rf"results\NFC-Noblur\order{self.order}", exist_ok=True)
        ...
        model_path = rf"..\models\envmodels\NFC-Noblur\NFC-Noblur_meadow_1k_order={self.order}_25.pth"
    ...
    def render(self, camera):
        ...
        save_path = os.path.join(rf"results\NFC-Noblur\order{self.order}", f"{self.model_name}_{self.shininess}_{self.mesh_name}_view{self.view_idx}.exr")
