...
class SceneOP(OpenGLOP):
    def __init__(self, resolution):
        ...
        self.shininess = 32
        self.order = 1
        os.makedirs(rf"results\NFC-MC\order{self.order}", exist_ok=True)
        ...
        model_path = rf"..\models\envmodels\NFC-MC\NFC-MC_meadow_1k_order={self.order+1}.pth"
    ...
    def render(self, camera):
        ...
        save_path = os.path.join(rf"results\NFC-MC\order{self.order}", f"{self.model_name}_{self.shininess}_{self.mesh_name}_view{self.view_idx}.exr")
